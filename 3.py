...
# === 保存模型 ===
joblib.dump(model_1, "model_region1.pkl")  # 保存 Region_1 的模型
joblib.dump(model_2, "model_region2.pkl")  # 保存 Region_2 的模型
print("✅ 模型已保存为 'model_region1.pkl' 和 'model_region2.pkl'")
